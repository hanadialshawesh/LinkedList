...
public class Problem1 {
    public static void main(String[] args) {
        ...
        CircularLinkedList<Integer>.Node<Integer> currentoriginal2 = original2.tail.next.next;//  2 3 4 5 1
        Integer current3 ;//  2 3 4 5 1
        ...
        current3 = currentOriginal.data ;

        System.out.println(isPalindrome ?  current3 :" " );
    }
}